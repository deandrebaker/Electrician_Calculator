...
public class Current extends JPanel implements ActionListener {
	...
	public Current(MainFrame frame) {
	...
	public void actionPerformed(ActionEvent evt) {
		...
		case "Calculate":
			...
			try {				
				resultField.setText(Calculate.current(vField.getText(), rField.getText(), units[0], units[2], units[1]));				
			}
			
			catch (Exception e) {				
				JOptionPane.showMessageDialog(this, "Please enter the voltage and resistance");				
			}
